...
namespace DoAnAnimals.Areas.admin.Controllers
{
    public class RegionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Region_ID,Region_Name,Description,Climate")] Region region)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Region_ID,Region_Name,Description,Climate")] Region region)
        {
            if (ModelState.IsValid)
            {
